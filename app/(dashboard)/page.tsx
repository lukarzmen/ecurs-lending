          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              <h1 className="text-4xl font-bold text-gray-900 tracking-tight sm:text-5xl md:text-6xl">
                Odkryj moc tworzenia
                <span className="block text-orange-500">interaktywnych kursów z Ecurs</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                Ecurs to platforma, która pozwala twórcom łatwo tworzyć i zarządzać nowoczesnymi,
                interaktywnymi kursami, dostępnymi na różnych urządzeniach.
              </p>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                Zarządzaj swoim kursem i kontaktem z uczniami bezpośrednio z poziomu platformy Ecurs.
              </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <div>
              <h2 className="text-lg font-medium text-gray-900">Intuicyjne Zarządzanie</h2>
              <p className="mt-2 text-base text-gray-500">
                Zarządzaj swoimi kursami w prosty i efektywny sposób dzięki naszym wbudowanym narzędziom. 
                Zarządzanie i płatności w jednym miejscu.
              </p>
            </div>
          </div>
        </div>
